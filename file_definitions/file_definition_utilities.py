...
def write_int16(writer: BufferedWriter, int: int, signed = False) -> None:
    writer.write(int.to_bytes(2, byteorder="little", signed=signed))

def write_int32(writer: BufferedWriter, int: int, signed = False) -> None:
